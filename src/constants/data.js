export const PLANETS_DATA = [
	{
		mercury: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-mercury.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-mercury-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-mercury.png',
...

	{
		venus: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-venus.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-venus-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-venus.png',
...

	{
		earth: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-earth.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-earth-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-earth.png',
	...
	},
	{
		mars: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-mars.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-mars-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-mars.png',
	...
	},
	{
		jupiter: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-jupiter.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-jupiter-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-jupiter.png',
	...
	},
	{
		saturn: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-saturn.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-saturn-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-saturn.png',
	...
	},
	{
		uranus: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-uranus.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-uranus-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-uranus.png',
	...
	},
	{
		neptune: {
			tabs: {
				overview: {
					img: '/public/planets-data/assets/planet-neptune.svg',
				...
				structure: {
					img: '/public/planets-data/assets/planet-neptune-internal.svg',
				...
				surface: {
					img: '/public/planets-data/assets/geology-neptune.png',
